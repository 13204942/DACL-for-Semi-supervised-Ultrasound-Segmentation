...
from networks.archs import UNext as Unext
from networks.projector import projectors
...
def net_factory(net_type="unet", in_chns=1, class_num=4, device='cuda:0'):
    if net_type == "unet":
